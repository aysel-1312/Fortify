...
<head>
    ...
    <link href="v{{asset('asset/vendor/perfect-scrollbar/perfect-scrollbar.css')}}" rel="stylesheet" media="all">
    ...
    <div class="page-container">
        ...
        ----------------------------------------------------------------------------------------------------------------------
                                            <form action="{{route('logout')}}" method="POST">
                                                @csrf
                                                <button style="display: none;" type="submit" id="tikla">Çıkış</button>
                                            </form>
                                            <a onclick='document.getElementById("tikla").click()' >
            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                <p>Copyright © 2021  <a href="https://colorlib.com">Fortify</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
